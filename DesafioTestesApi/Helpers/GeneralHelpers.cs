...
namespace DesafioTestesApi.Helpers
{
    public class GeneralHelpers
    {
        ...
        public static string TrataRetornoBool(string variavel)
        {
            if (variavel == "0")
            {
                return "False";
            ...
            return "Retorna diferente de bool";
        }


        public static string GeraStringAutomatica(int size)
        {
        ...
        public static string GeraNumeroAutomatico(int size)
        {
            Random random = new Random();
